// Real Vaultguards catalog data, pulled from vaultguards.co (Shopify storefront)
// Prices, handles, images and stock are the live values as of the data pull.
// Update `stock` as inventory changes on Shopify — this file mirrors it for The Vault + bundle logic.
...
export interface Guard {
  ...
  brand: Brand;
  price: number;
  image: string; // real product photo, front-facing, white background
